  ...
  en: {
    ...
    proof: {
      ...
      cases: [
        ...
        {
          name: 'TeSorteo',
          text: 'Raffle and lottery platform with Wompi payments, GTM/GA4 analytics, multi-tenant architecture, and full production deployment.',
          image: '/images/projects/tesorteo-home.webp',
          alt: 'TeSorteo screenshot',
          link: 'https://tesorteo.com',
        },
        {
          name: 'PlátanoControl',
          text: 'Agricultural management platform for banana farmers. Expense tracking, field operations, PWA + Android app.',
          image: '/images/projects/platanocontrol-home.webp',
          alt: 'PlátanoControl screenshot',
          link: 'https://platanocontrol.com',
        },
        {
          name: 'CelularesBaratos',
          text: 'E-commerce catalog auto-generated from wholesale PDF. Cart, PayPal checkout, and daily automated updates.',
          image: '/images/projects/celularesbaratos-home.webp',
          alt: 'CelularesBaratos screenshot',
          link: 'https://celularesbaratos.ivanrene.com',
        },
        {
          name: 'PayPay',
          text: 'Centralized payment microservice (Wompi) consumed by multiple platforms. FastAPI, API key auth, prod + dev environments.',
          image: '/images/projects/paypay-home.webp',
          alt: 'PayPay screenshot',
          link: 'https://pay.digitalplatformservices.com',
        },
      ],
    },
    outsourcing: {
  ...
  es: {
    ...
    proof: {
      ...
      cases: [
        ...
        {
          name: 'TeSorteo',
          text: 'Plataforma de rifas y sorteos con pagos Wompi, analítica GTM/GA4, arquitectura multi-tenant y despliegue completo en producción.',
          image: '/images/projects/tesorteo-home.webp',
          alt: 'Captura TeSorteo',
          link: 'https://tesorteo.com',
        },
        {
          name: 'PlátanoControl',
          text: 'Plataforma de gestión agrícola para cultivos de plátano. Trazabilidad de gastos, operaciones de campo, PWA + app Android.',
          image: '/images/projects/platanocontrol-home.webp',
          alt: 'Captura PlátanoControl',
          link: 'https://platanocontrol.com',
        },
        {
          name: 'CelularesBaratos',
          text: 'Catálogo e-commerce generado automáticamente desde PDF mayorista. Carrito, checkout PayPal y actualización diaria automatizada.',
          image: '/images/projects/celularesbaratos-home.webp',
          alt: 'Captura CelularesBaratos',
          link: 'https://celularesbaratos.ivanrene.com',
        },
        {
          name: 'PayPay',
          text: 'Microservicio centralizado de pagos (Wompi) consumido por múltiples plataformas. FastAPI, auth por API key, entornos prod y dev.',
          image: '/images/projects/paypay-home.webp',
          alt: 'Captura PayPay',
          link: 'https://pay.digitalplatformservices.com',
        },
